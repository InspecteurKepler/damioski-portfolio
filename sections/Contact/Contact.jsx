...
const Contact = () => {
    ...
    return (
        <motion.section 
            id="contact" 
            className="contact-section nextjs-background with-glow"
            initial="hidden"
            whileInView="visible"
                ...
                <div className="contact-container">
                    <div className="contact-info">
                        ...
                        <motion.div className="social-links" variants={itemVariants}>
                            <a href="https://github.com/InspecteurKepler/" target="_blank" rel="noopener noreferrer" className="social-link">
                            ...
                            <a href="https://www.linkedin.com/in/enzo-delhaye-wolff/" target="_blank" rel="noopener noreferrer" className="social-link">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="https://x.com/DAMIOSKI/" target="_blank" rel="noopener noreferrer" className="social-link">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
